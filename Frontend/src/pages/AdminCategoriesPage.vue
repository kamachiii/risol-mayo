...
220|.admin-top { display: flex; align-items: center; margin-bottom: 16px; }
...
318|  .admin-tabs { overflow-x: auto; }
  .admin-tab { white-space: nowrap; font-size: 12px; padding: 6px 10px; }
322|  .admin-header h1 { font-size: 18px; }
